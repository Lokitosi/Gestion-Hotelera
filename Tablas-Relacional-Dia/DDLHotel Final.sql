...
/*  Created On : 23-feb-2021 10:22:27 PM 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
(
	...
	k_idHotel varchar(5) NOT NULL,	-- Codigo identificador del hotel
	...
	i_estado char(1) NOT NULL,	-- Estado de la reserva, este varia en dos posibles valores, "a" para reservas activas e "i" para reservas inactivas.
...
COMMENT ON TABLE Persona
	IS 'Tabla correspondiente a los datos de la persona, engloba todos los datos del usuario.'
;
...
COMMENT ON COLUMN Reserva.k_idHotel
	IS 'Codigo identificador del hotel'
;
...
COMMENT ON COLUMN Reserva.i_estado
	IS 'Estado de la reserva, este varia en dos posibles valores, "a" para reservas activas e "i" para reservas inactivas.'
;
