...
/*  Created On : 07-feb.-2021 2:53:54 p. m. 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
(
	...
	q_telefono numeric(10) NOT NULL	-- Numero telefonico unico con el cual se pueda contactar el hotel.
)
;
...
COMMENT ON COLUMN Persona.q_telefono
	IS 'Numero telefonico unico con el cual se pueda contactar el hotel.'
;
